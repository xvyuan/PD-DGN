...
PD-DGN is a graph neural network framework designed for drug--target
...
Twelve RDKit molecular descriptors are projected into the latent
affinity space and fused through gated residual learning.
...
<p align="center">
```
`<img src="figures/prediction_scatter.png" width="600">`{=html}
```{=html}
</p>
```
